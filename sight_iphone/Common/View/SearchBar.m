...
#define kSearchBarButtonTextColor             [UIColor colorWithHex:0x77FFFF alpha:1.0f]
#define kSearchBarButtonTextPressColor        [UIColor colorWithHex:0x77FFFF alpha:0.5f]
...
- (void)initlizeWithTitle:(NSString*)title
{
    ...
    [_textField setFont:kSearchBarTextFieldFont];
    ...
    [_buttonBack setImage:[UIImage imageNamed:kNaviBackBarButtonNormalImageFile]
                           forState:UIControlStateNormal];
    [_buttonBack setImage:[UIImage imageNamed:kNaviBackBarButtonHighlightedImageFile]
                           forState:UIControlStateHighlighted];
    [_buttonBack setImage:[UIImage imageNamed:kNaviBackBarButtonDisableImageFile]
...
- (void)reLayout:(BOOL)animated
{
	...
	if(_buttonBar != nil)
	{
		...
		{
			CGSize titleSize = [buttonTitle sizeWithFontCompatible:kSearchBarButtonFont];
	...
	if(_labelHint != nil)
	{
		if(_isLabelShow)
		{
			...
			{
				CGSize hintSize = [hintText sizeWithFontCompatible:kSearchBarLabelFont];
